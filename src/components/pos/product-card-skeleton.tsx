    ...
    <div className="flex h-full w-full flex-col justify-between gap-2 overflow-hidden rounded-2xl border border-border/70 bg-card p-2 shadow-sm">
      <div className="flex flex-col gap-1.5">
        ...
        <div className="flex flex-wrap items-center gap-1">
          <SkeletonText width="45%" height="sm" className="bg-muted" />
        </div>
      </div>
...
export function ProductCardSkeletonGrid({ count = 12 }: { count?: number }) {
  return (
    <div className="grid w-full grid-cols-2 gap-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-5">
